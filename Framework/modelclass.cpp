...
bool ModelClass::CallInitialize(ID3D11Device* device, int shape)
{
	switch (shape)
	{
	case 0:
		return Initialize(device, L"./data/cube.obj", L"./data/sea.dds", 1);
		break;
	case 1:
		return Initialize(device, L"./data/warship.obj", L"./data/warship.dds", 1);
		//return Initialize(device, L"./data/DDG51.obj", L"./data/DDG51.dds");
		break;
	case 2:
		return Initialize(device, L"./data/warship2.obj", L"./data/warship2.dds", 1);
		//return Initialize(device, L"./data/DDG51.obj", L"./data/DDG51.dds");
		break;
	case 3:
		return Initialize(device, L"./data/warship3.obj", L"./data/warship3.dds", 1);
		//return Initialize(device, L"./data/DDG51.obj", L"./data/DDG51.dds");
		break;
	case 4:
		return Initialize(device, L"./data/Luvdisc.obj", L"./data/Luvdisc.dds", 4);
		break;
	case 5:
		return Initialize(device, L"./data/fish.obj", L"./data/fish.dds", 2);
		break;
	case 6:
		return Initialize(device, L"./data/seagull.obj", L"./data/seagull.dds", 11);
		break;
	case 7:
		return Initialize(device, L"./data/pirateship0.obj", L"./data/pirateship0.dds", 1);
		break;
	case 8:
		return Initialize(device, L"./data/pirateship2.obj", L"./data/pirateship2.dds", 1);
		break;
	case 9:
		return Initialize(device, L"./data/pirateship3.obj", L"./data/pirateship3.dds", 1);
		break;
	}
}
...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	//인스턴스 배치 (새 떼들의 편대 비행 느낌 연출)
	int half = m_instanceCount / 2;
	for (int i = 0; i < m_instanceCount; ++i)
	{
		int relIndex = i - half;

		float x = -abs(relIndex) * 10.0f; 
		float y = relIndex * 8.0f;
		float z = 0.0f;
