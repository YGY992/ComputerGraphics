...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, 
	...
	XMFLOAT4 pointLightPos[NUM_LIGHTS], XMFLOAT4 pointLightColor[NUM_LIGHTS])
{
	bool result;
	...
	XMFLOAT4 pointLightPos[NUM_LIGHTS], XMFLOAT4 pointLightColor[NUM_LIGHTS])
{
	...
	{
		dataPtr2->lightPosition[i] = pointLightPos[i];
		dataPtr2->pointDiffuseColor[i] = pointLightColor[i];
	}
	dataPtr2->lightPosition[0] = pointLightPos[0];
	dataPtr2->lightPosition[1] = pointLightPos[1];
	dataPtr2->lightPosition[2] = pointLightPos[2];
	dataPtr2->lightPosition[3] = pointLightPos[3];
	...
	//// Copy the lighting variables into the constant buffer.
	//dataPtr4->lightPosition[0] = pointLightPos[0];
	//dataPtr4->lightPosition[1] = pointLightPos[1];
	//dataPtr4->lightPosition[2] = pointLightPos[2];
	//dataPtr4->lightPosition[3] = pointLightPos[3];

	//// Unlock the constant buffer.
	//deviceContext->Unmap(m_lightPositionBuffer, 0);

	//// Finally set the light constant buffer in the pixel shader with the updated values.
	////deviceContext->PSSetConstantBuffers(1, 1, &m_lightPositionBuffer);
