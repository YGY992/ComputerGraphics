...
bool ModelClass::CallInitialize(ID3D11Device* device, int shape)
{
	...
	{
	case 0:
		return Initialize(device, L"./data/cube.obj", L"./data/pattern.dds");
		break;
	case 1:
		return Initialize(device, L"./data/daraq.obj", L"./data/daraq.dds");
		break;
	case 2:
		return Initialize(device, L"./data/trainer.obj", L"./data/trainer.dds");
		break;
	case 3:
		return Initialize(device, L"./data/dummy.obj", L"./data/dummy.dds");
		break;
	}
}
